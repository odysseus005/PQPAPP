...
/**
 * Created by markulyssesdeleon on 08/01/2019.
 */
...
public class YearMonthPickerDialog implements Dialog.OnClickListener {
     ...
     */
    private YearMonthPickerDialog.OnDateSetListener mOnDateSetListener;
     ...
     */
    public YearMonthPickerDialog(Context context, YearMonthPickerDialog.OnDateSetListener onDateSetListener) {
     ...
     */
    public YearMonthPickerDialog(Context context, YearMonthPickerDialog.OnDateSetListener onDateSetListener, int theme) {
     ...
     */
    public YearMonthPickerDialog(Context context, YearMonthPickerDialog.OnDateSetListener onDateSetListener, int theme, int titleTextColor) {
        mContext = context;
